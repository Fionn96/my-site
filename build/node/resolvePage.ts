...
export const resolvePageFile = (route: any) => {
  ...
  const isNotes = routePath.includes('/docs/notes')
  const isLifeStyle = routePath.includes('/docs/lifestyle')
  const isGames = routePath.includes('/docs/games')
  ...
  route.meta = Object.assign(route.meta || {}, {
    ...
    isLifeStyle,
    isGames,
    layout: (isPost || isGames || isLifeStyle || isNotes) ? 'post' : 'default',
    date: (isNotes || isGames) ? routePath.substring(12, 22) : isLifeStyle ? routePath.substring(16, 26) : routePath.substring(7, 17),
